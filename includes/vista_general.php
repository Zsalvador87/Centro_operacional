...
$output['data'] .= '<h4 class="tj__titulo">Performance Promedio</h4>';
...
$output['data'] .= '<div class="tj-tipo1__indicadores">';
$output['data'] .= '<p>Ejecutado    <span>'. $datos['tpo_no_disponible'] .'</span></p>';
...
$output['data'] .= '<div class="tj-tipo1__indicadores">';
$output['data'] .= '<p>Ejecutado    <span>'. $datos['tpo_baño'] .'</span></p>';
...
$output['data'] .= '<div class="tj-tipo1__indicadores">';
$output['data'] .= '<p>Ejecutado    <span>'. $datos['tpo_hablando'] .'</span></p>';
...
$output['data'] .= '<div class="tj-tipo1__indicadores">';
$output['data'] .= '<p>Ejecutado    <span>'. $datos['tpo_descanso'] .'</span></p>';
