...
//Filtro
if($campo != null){
    $where .= "AND plantilla.coordinador LIKE '%" . $campo . "%'";
}
...
$output['data'] .= '<div class="tj-tipo1__indicadores">';
$output['data'] .= '<p>Ejecutado    <span class="valores_graficaC">'. $datos['tpo_disponible'] .'</span></p>';
...
$output['data'] .= '<div class="tj-tipo1__indicadores">';
$output['data'] .= '<p>Ejecutado    <span class="valores_graficaC">'. $datos['tpo_no_disponible'] .'</span></p>';
$output['data'] .= '<p>Objetivo     <span>'. $o_tpoNoDisponible .'</span></p>';
$output['data'] .= '<p>Desviación   <span>'. ($o_tpoNoDisponible - $datos['tpo_no_disponible']) .'</span></p>';
$output['data'] .= '</div>';
$output['data'] .= '</div>';
...
$output['data'] .= '<div class="tj-tipo1__indicadores">';
$output['data'] .= '<p>Ejecutado    <span class="valores_graficaC">'. $datos['tpo_baño'] .'</span></p>';
...
$output['data'] .= '<div class="tj-tipo1__indicadores">';
$output['data'] .= '<p>Ejecutado    <span class="valores_graficaC">'. $datos['tpo_hablando'] .'</span></p>';
...
$output['data'] .= '<div class="tj-tipo1__indicadores">';
$output['data'] .= '<p>Ejecutado    <span class="valores_graficaC">'. $datos['tpo_descanso'] .'</span></p>';
