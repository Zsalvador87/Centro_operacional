...
<body>
    ...
    <main class="contenido">
        ...
        <section id="tarjetas_gerentes" class="tarjetas-equipos">
        </section>

        <section class="tbEquipos">
            <div class="tbEquipos__titulo">
                <h2>Supervisores</h2>
            </div>

            <div class="tbEquipos__filtro">
                <div>
                    <label for="filtro__coordinador">Coordinadores:</label>
                    <select id="campo" name="campo">
                        <option value="">--GENERAL--</option>
                        <?php while($coordinador = mysqli_fetch_assoc($consulta_coordinadores)) { ?>
                            <option><?php echo $coordinador['coordinador']; ?></option>
                        <?php } ?>
                    </select>
                </div>
            </div>

            <div class="tbe__registros">
                <table>
                    <thead>
                        <tr>
                            <th>Nombre</th>
                    ...
                    <tbody id="tbe_tabla">
                        <!-- Aquí se llenarán dinámicamente con JS -->
                    </tbody>
                </table>
            </div>
